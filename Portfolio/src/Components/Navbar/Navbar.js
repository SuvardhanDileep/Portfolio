...
const Navbar = () => {
    return (
        <div>
            <nav class="navbar navbar navbar-fixed-top" style={{ backgroundColor: 'rgb(0, 153, 153)' }}>
                <div class="container-fluid">
                    <div class="navbar-header">
                        {/* <a><div class="div-block-4"></div></a> */}
                        <a class="navbar-brand" href="#" style={{ fontFamily: "Georgia", color: 'black' }}><div class="div-block-4" style={{marginTop:'-8px'}}></div></a>
                    </div>
            ...
            <div id="aboutme" >
                <div class="container" style={{ height: '675px' }}>
                    ...
                    <div className="row jumbotron" style={{ marginTop: '140px' }}>
                        <div className="col-md-6 bar" ><img src="https://i.postimg.cc/K85vVP8R/My-Photo.jpg" class="img-rounded" id="Myphoto" alt="Myphoto" border="0" style={{ height: '400px' }} /></div>
            ...
            <div id="contact">
                ...
                <div className="container" >
                        ...
                        <div className='col-md-6'>
                            <div>
                                ...
                                <p>
                                    ...
                                    <span style={{ fontSize: "20px", color: 'white' }}>E-mail : <a href="mailto:gsuvardhandileep@gmail.com" target="_blank" style={{ fontFamily: "Roboto Condensed", fontSize: "20px", color: 'white' }} >gsuvardhandileep@gmail.com</a></span>
                                </p>
                            </div>
                            ...
                            <div className="contactform" style={{ marginTop: '12px' }}>
                                <form>
                                    ...
                                    <input class="email" name="Email" placeholder='Email' required></input>
                                    <input class="phone" name="Phone" placeholder='Phone' required></input>
                    ...
                    <h2>&copy; Suvardhan Dileep's Website</h2>
                    </div>
                </div>
            </div>
        </div>
